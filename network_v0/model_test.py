...
def one_warp_batch_test():
  ...
  coor_change_trans = []
  for _ in range(B):
    trans1 = torch.tensor([random.uniform(-2, 2), random.uniform(-2, 2), random.uniform(-10, -15)])
    trans2 = torch.tensor([random.uniform(-2, 2), random.uniform(-2, 2), random.uniform(-10, -15)])
    axis1 = normalize_vec([random.uniform(-.05, .05), random.uniform(-.05, .05), 1])
    axis2 = normalize_vec([random.uniform(-.05, .05), random.uniform(-.05, .05), 1])
